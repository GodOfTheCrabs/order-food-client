  ...
  <div class="analytics-container" style="margin-top: 35px; ">
    ...
    <div class="analytics-card">
      ...
      <div class="analytics-stats-row">
        ...
        <div class="analytics-stat-block">
          <div class="analytics-stat-value" style="color: green">350 грн</div>
          <div class="analytics-stat-label">Ліміт на день</div>
        </div>
        <div class="analytics-stat-block">
          <div class="analytics-stat-value" style="color: red">7 645 грн</div>
          <div class="analytics-stat-label">Ліміт на місяц</div>
        </div>
      </div>
    </div>
  </div>
